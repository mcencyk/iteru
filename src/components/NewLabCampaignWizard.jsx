...
const CAMPAIGN_PARAMS_PRIMARY = [
  { key: 'flashDurHV',       label: 'Flash Duration HV',           defaultVal: '102',      unit: 'sec.',  tooltip: 'Max time allowed for high-voltage ECU firmware flashing' },
  { key: 'flashDurLV',       label: 'Flash Duration LV',           defaultVal: '102',      unit: 'sec.',  tooltip: 'Max time allowed for low-voltage ECU firmware flashing' },
  ...
  { key: 'installFailAction',label: 'Installation Failure Action', defaultVal: 'Continue', unit: '',      tooltip: 'Behavior when an ECU installation fails mid-campaign' },
];
